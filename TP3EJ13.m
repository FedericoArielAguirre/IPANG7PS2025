...
for i = 1:3
    ...
    for j = 1:size(P_data, 1)-1
        ...
        if t1 < edad_diagnostico
            ...
            integral_value = integral_value + (P1 - 13 + P2 - 13) / 2 * (t2 - t1);
        end
    end
    integrales(i) = integral_value; % Guardar el valor de la integral
end
...
% Mostrar resultados
fprintf('Valor estimado de k: %.4f\n', k);
fprintf('Valor estimado de A: %.4f\n', A);